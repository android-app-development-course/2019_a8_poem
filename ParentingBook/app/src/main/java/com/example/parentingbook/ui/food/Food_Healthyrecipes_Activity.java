...
public class Food_Healthyrecipes_Activity extends AppCompatActivity {
    //ListView文章列表
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.food_healthyrecipes);

        //类实现、ListView与适配器
        iniArticlesList();
        //RecyclerView实现
        RecyclerView rv=(RecyclerView)findViewById(R.id.food_healthyrecipes_articles);
        ...
        adv=(ImageView)findViewById(R.id.food_healthyrecipes_adv);
        adv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                //跳转到指定链接
//                Intent intent = new Intent(Food_Healthyrecipes_Activity.this, WebViewActivity.class);
//                //将数据存入Intent
//                intent.putExtra("href", "https://www.qbb6.com/recipe/plan/NelcCMF?src=lib&trackid=509860105&trackinfo=hhH9LrIFt4f&source=qbb&versioncode=450&env=prod");
