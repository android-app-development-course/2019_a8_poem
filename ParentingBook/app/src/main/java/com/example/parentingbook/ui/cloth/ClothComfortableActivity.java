...
public class ClothComfortableActivity extends AppCompatActivity {
    //ListView文章列表
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cloth_comfortable);

        //类实现、ListView与适配器
        iniArticlesList();
        //RecyclerView实现
        RecyclerView rv=(RecyclerView)findViewById(R.id.cloth_comfortable_articles);
        rv.setLayoutManager(new LinearLayoutManager(ClothComfortableActivity.this));
        RecycleAdapter myadapter=new RecycleAdapter(ClothComfortableActivity.this,articlesList);
        //设置间距
        rv.addItemDecoration(new SpacesItemDecoration(10));
        rv.setAdapter(myadapter);

        adv=(ImageView)findViewById(R.id.cloth_comfortable_adv);
        adv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                //跳转到指定链接
//                Intent intent = new Intent(ClothComfortableActivity.this, WebViewActivity.class);
//                //将数据存入Intent
...
//                startActivity(intent);
                Uri uri = Uri.parse("https://www.qbb6.com/article/DZNrWYfWk?src=lib&trackid=509860105&trackinfo=hhH9LrIFt4f&source=qbb&versioncode=450&env=prod");
