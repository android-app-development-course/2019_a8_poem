...
public class Food_Nutrition_Activity extends AppCompatActivity {
    //ListView文章列表
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.food_nutrition);

        //类实现、ListView与适配器
        iniArticlesList();
        //RecyclerView实现
        RecyclerView rv=(RecyclerView)findViewById(R.id.food_nutrition_articles);
        ...
        adv=(ImageView)findViewById(R.id.food_nutrition_adv);
        adv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                //跳转到指定链接
//                Intent intent = new Intent(Food_Nutrition_Activity.this, WebViewActivity.class);
//                //将数据存入Intent
