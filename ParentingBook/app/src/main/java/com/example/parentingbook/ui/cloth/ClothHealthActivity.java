...
public class ClothHealthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cloth_health);

        //类实现、ListView与适配器
        iniArticlesList();
        //RecyclerView实现
        RecyclerView rv=(RecyclerView)findViewById(R.id.cloth_health_articles);
...
//                if(dy>3){
//                    findViewById(R.id.cloth_health_adv).setVisibility(View.INVISIBLE);
//                }else if(dy<-3){
//                    findViewById(R.id.cloth_health_adv).setVisibility(View.VISIBLE);
//                }
//            }
//        });

        adv=(ImageView)findViewById(R.id.cloth_health_adv);
        adv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                //跳转到指定链接
//                Intent intent = new Intent(ClothHealthActivity.this, WebViewActivity.class);
//                //将数据存入Intent
