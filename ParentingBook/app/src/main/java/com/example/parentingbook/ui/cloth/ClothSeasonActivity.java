...
public class ClothSeasonActivity extends AppCompatActivity {
    //ListView文章列表
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cloth_season);

        //类实现、ListView与适配器
        iniArticlesList();
        //RecyclerView实现
        RecyclerView rv=(RecyclerView)findViewById(R.id.cloth_season_articles );
        ...
        adv=(ImageView)findViewById(R.id.cloth_season_adv);
        adv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                //跳转到指定链接
//                Intent intent = new Intent(ClothSeasonActivity.this, WebViewActivity.class);
//                //将数据存入Intent
